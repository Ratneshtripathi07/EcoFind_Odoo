...
export default function NewListingPage() {
  ...
  const handleReview = (e: React.FormEvent) => {
    e.preventDefault();
    router.push('/dashboard/listings/new/confirm');
  };
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle className="font-headline text-3xl">Add a new Product (Step 1 of 2)</CardTitle>
        ...
        <form onSubmit={handleReview} className="space-y-8">
            ...
            <div className="space-y-2">
                 <AiDescriptionGenerator 
                    ...
                    onDescriptionGenerated={(desc) => handleInputChange('description', desc)}
                />
